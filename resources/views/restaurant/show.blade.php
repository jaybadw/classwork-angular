...
<section class="background-radial-gradient mb-4">
    <style>
            ...
            <div class="grid items-center gap-12 lg:grid-cols-2">
                <div class="mt-12 lg:mt-0">
                    ...
                    <h1
                        ...
                        {{$restaurant->name}}
                        <br /><span class="text-[hsl(218,81%,75%)]">
                            {{$restaurant->description}}
                        </span>
                    </h1>
                    <p class="text-white mb-2">
                        {{$restaurant->address}} {{$restaurant->rating}}</p>
                   
                   <p class="text-white mb-2"> 
                    {{$restaurant->parish}}
                </p>
                   <p class="text-white mb-2">Opening Hours:  Mon-thur  
                    ...
                    {{-- @if ($restaurant->isOpen)
                        <p>The restaurant is currently open.</p>
                    @else
                ...
                <div class="mb-12 lg:mb-0">
                    <img src="{{asset('storage\images\1687204556.jpg')}}"
